...
$pg = ob_get_contents();
$pageTitle = 'Book Trailer | Book Publisher Expert';
...
<header>
    ...
    <section class="header-display">
        ...
        <div class="header-display-text-content">
            <h1>Excite Readers With Stunning Book’s Trailer</h1>
            <p>Sneak peek for the audience making them want more.</p>
        </div>
    </section>
</header>
        ...
        <div class="section-16-container">
            ...
            <div class="section-16-main-content">
                ...
                <div class="section-16-main-text">
                    <h1>A Trailer That Pulls Readers In From The First Look.</h1>

                    <p>Book Publisher Experts create attractive book trailers that grab your audience’s attention. We offer both written trailers and window trailers to match your goals. The BPE team coordinates with you to craft a trailer that captures your book’s story and tone. We use striking visuals, narration, and music to spark curiosity and leave readers eager to learn more.</p>

                    <p>With years of experience, BPE ensures that your trailer stands out and promotes your book effectively. We focus on delivering high-quality trailers that create excitement and boost visibility.</p>

                    <p>Let BPE help you create a trailer that will draw readers in and increase interest in your book. Reach out today to get started and make your book unforgettable.</p>
