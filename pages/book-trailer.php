...
<body>
    <header>
        ...
        <section class="header-display">
            <img src="assets/images/book-trailer-bg-image.jpeg">
            <div class="header-display-text-content">
                <h1>BOOK TRAILER</h1>
                <p>Take your story across the digital borders.</p>
            </div>
        </section>
    </header>
            ...
            <div class="section-16-container">
                ...
                <div class="section-16-main-content">
                    ...
                    <div class="section-16-main-text">
                        <h1>YOUR JOURNEY, OUR WORDS – A PERFECT MATCH!</h1>

                        <p>Writing an book trailer might be more difficult than it seems. How do you express your life via words?</p>

                        <p>You've experienced every high and low, and not everyone can put it on paper. Here's where our team can assist!</p>

                        <p>Our staff aims to assist you in sharing your story in your own unique voice, not to dictate how you should tell it. So, if you're ready to share your tale with the world, contact us. Our creative book trailer staff will get to know your narrative, including your highs and lows. Our book trailer service can present your narrative in an engaging manner for readers. We provide services for writing professional book trailers, non-fiction book trailers, and creative book trailers.</p>
