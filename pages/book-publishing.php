...
<body>
    <header>
        ...
        <section class="header-display">
            ...
            <div class="header-display-text-content">
                <h1>WORK WITH THE BOOK PUBLISHING EXPERTS</h1>
                <p>From manuscripts to masterpieces!</p>
            </div>
        </section>
    </header>
            ...
            <div class="section-16-container">
                ...
                <div class="section-16-main-content">
                    ...
                    <div class="section-16-main-text">
                        <h1>TRANSFORMING WRITERS INTO AUTHORS!</h1>

                        <p>Enter the world of professional book publishing, where we transform prospective writers into recognised authors.</p>

                        <p>Our staff addresses each publishing project in a personalised, professional, and enthusiastic manner.</p>

                        <p>We recognise that when you contact us, you are not merely wanting to "publish a book." Rather, you need a full experience that includes everything from book editing to publication to strategic marketing.</p>

                        <p>To guarantee that your experience with us is flawless, we have a staff that works around the clock to ensure that your manuscript reaches your intended audience without incident. Whether it's book publishing or another platform, your hunt for a "book publisher near me" ends here!</p>
    ...
    <?php include("includes/Addons.php"); ?>
    <?php include("includes/Promises.php"); ?>
    <?php include("includes/Selling_Companies.php"); ?>
            ...
            <div class="section-14-container">
                ...
                <div class="section-14-profile">
                    <div class="section-14-navbar">
                        ...
                        <a class="section-14-category active" data-category="action_books">Action</a>
    ...
    <?php include("includes/Kickstart.php"); ?>
