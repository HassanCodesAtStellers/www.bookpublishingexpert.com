...
$pg = ob_get_contents();
$pageTitle = 'Book Publishing | Book Publisher Expert';
...
<header>
    ...
    <section class="header-display">
        <img src="assets/images/book-publishing-bg-image.jpeg">
        <div class="header-display-text-content">
            <h1>Trust Book Publisher Expert From Concept To Publication</h1>
            <p>Trusted Book Publishing Partner.</p>
        </div>
    </section>
</header>
        ...
        <div class="section-16-container">
            ...
            <div class="section-16-main-content">
                <div class="section-16-image">
                    <img src="assets/images/book-publishing-image.webp">
                </div>
                <div class="section-16-main-text">
                    <h1>Publish With Book Publisher Expert, Globally</h1>

                    <p>Book Publisher Expert makes it easier for authors to publish their books to reach an international audience. </p>

                    <p>Our team makes sure that your book is professionally edited, formatted, and ready to be published on Amazon, Kindle, Barnes & Noble Press, Apple Books, IngramSpark, Kobo, Lulu, Bookmate, and Blurb, as well as self-publishing on your own Author's website. We will help you with every step of the process, from writing the manuscript to advertising and publishing it. BPE ensures that your book stands out in all of the publishing platforms with the highest quality standards. We work with you to understand your book's requirements and combine them with our publishing expertise, allowing you to confidently publish your book and connect with readers all over the world. </p>

                    <p>Let Book Publisher Expert help your book reach its full potential by connecting with your targeted audience.</p>
        ...
        <div class="section-14-container">
            ...
            <div class="section-14-profile">
                <div class="section-14-navbar">
                    ...
                    <a class="section-14-category active" data-category="action_books">Mystery & Suspense</a>
